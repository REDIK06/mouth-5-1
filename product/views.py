...
def category_detail_api_view(request, id):
    try:
        ...
        return Response(data={'error_message': 'Category not found'}, status=status.HTTP_404_NOT_FOUND)
...
def product_detail_api_view(request, id):
    try:
        ...
        return Response(data={'error_message': 'Product not found'}, status=status.HTTP_404_NOT_FOUND)
